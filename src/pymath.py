...
'''
Get the curvature of a function.
'''
def curvature(x: float, y: float, x1: float, y1: float, x2: float, y2: float) -> float:
...
'''
Calculate the line integral of a function.
'''
def line_integral(f, a, b, n):
    h = (b - a) / n
    result = 0
